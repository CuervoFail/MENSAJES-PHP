...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2020 a las 01:08:07
...
('root', '[{\"db\":\"test\",\"table\":\"mensajes\"},{\"db\":\"test\",\"table\":\"usuarios\"}]');
...
('root', '2020-11-04 00:07:45', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
...
--
ALTER TABLE `mensajes`
  MODIFY `id_mensajes` int(7) NOT NULL AUTO_INCREMENT;
